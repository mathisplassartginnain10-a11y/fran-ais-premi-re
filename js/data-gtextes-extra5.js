/* Grands textes — lot 6 (GT-121 → GT-140) · fusion au chargement */
const GRANDS_TEXTES_EXTRA5 = [
  {
    id: "GT-121",
    titre: "Gargantua — naissance",
    auteur: "Rabelais",
...
Couvre de sa gloire éclatante les choses les plus tristes.`,
    ...
    attendus: [
      ...
      { procede: "Champ lexical", citation: "« colombes », « tombes », « pins »", interpretation: "Autour de « colombes » face à « tombes », le vocabulaire (« colombes », « tombes », « pins ») forme un réseau sémantique : le lecteur perçoit méditation existentielle par accumulation lexicale.", keywords: ["champ lexical", "colombes", "tombes", "pins", "funèbre", "méditat"] },
...
Il ne se laisse pas dompter ; il ne se laisse pas lier.`,
    ...
    attendus: [
      ...
      { procede: "Parallélisme", citation: "« ne se laisse pas dompter ; ne se laisse pas lier »", interpretation: "Parallélisme: « ne se laisse pas dompter; ne se laisse pas lier » reproduit une éclaire du syntaxique identique. La symétrie renforce napoléon iii et crée un effet de martèlement.", keywords: ["parallélisme", "dompter", "lier", "liberté", "martel", "refus"] }
    ]
  },
  {
    id: "GT-125",
...
Flotte très lentement, couchée en ses longs voiles…`,
    ...
    attendus: [
      ...
      { procede: "Registre pathétique", citation: "« Ophélia flotte »", interpretation: "À travers « Ophélia flotte », le registre pathétique domine et suscite la compassion et l'indignation face à la souffrance.", keywords: ["pathétique", "ophélie", "pit", "noyée", "tragique", "beauté"] },
      { procede: "Champ lexical", citation: "« onde calme », « étoiles », « voiles »", interpretation: "Arthur Rimbaud densifie le passage avec un champ lexical centré sur onde (« onde », « calme », « étoiles », « voiles »), ce qui insiste sur l'idée centrale par résonance lexicale et ancre le thème de symbolisme précoce.", keywords: ["champ lexical", "onde", "étoiles", "voiles", "nocturn", "oniriq"] },
  ...
  {
    id: "GT-126",
    titre: "Les Femmes savantes — Trissotin",
    auteur: "Molière",
...
Le sens, qui doit partout l'emporter et régir.`,
    ...
    attendus: [
      ...
      { procede: "Registre satirique", citation: "débat sur la rime", interpretation: "À travers débat sur la rime, le texte bascule dans un registre satirique ; le lecteur est invité à critiquer les mœurs et les institutions par le rire, ce qui s'inscrit dans Les Femmes savantes.", keywords: ["satirique", "pédant", "moque", "mœurs", "comédie", "savant"] },
      { procede: "Alexandrin", citation: "vers en douze syllabes", interpretation: "L'alexandrin repérée dans le vers en douze syllabes retarde ou brise le rythme attendu; le découpage du vers sert satire des précieuses dans Les Femmes savantes.", keywords: ["alexandrin", "vers", "classique", "règle", "douze", "forme"] }
    ]
  },
  {
    id: "GT-127",
...
Tout ce que tu voudras, tout ce que tu demanderas sera accompli.`,
    ...
    attendus: [
      ...
      { procede: "Registre fantastique", citation: "promesse surnaturelle", interpretation: "Registre fantastique: par « promesse surnaturelle », Honoré de Balzac trouble la frontière entre réel et surnaturel — tonalité dominante de La Peau de chagrin.", keywords: ["fantastique", "surnaturel", "pacte", "réalisme", "irrupt", "magie"] }
    ]
  },
  {
    id: "GT-128",
    titre: "Nana — le théâtre",
    auteur: "Émile Zola",
    oeuvre: "Nana (1880)",
  ...
  {
    id: "GT-130",
    titre: "Partage de midi — ouverture",
    auteur: "Paul Claudel",
...
Passa sans bruit sans bruit sans bruit`,
    ...
    attendus: [
      ...
      { procede: "Vers libre", citation: "vers courts irréguliers", interpretation: "Vers libre repéré dans le passage: l'absence de contrainte métrique fixe laisse le sens et la musicalité primer dans le paris.", keywords: ["vers libre", "court", "rupture", "moderne", "apollin", "irrégul"] },
      { procede: "Registre lyrique", citation: "« La Jolie Rousse »", interpretation: "À travers « La Jolie Rousse », le registre lyrique domine et exprime une subjectivité intime et des émotions personnelles.", keywords: ["lyrique", "émotion", "histoire", "subjectiv", "personnel", "guerre"] },
      { procede: "Champ lexical", citation: "« rive », « fleuve », « bateau »", interpretation: "Le champ lexical repéré (« rive », « fleuve », « bateau ») enveloppe « rive » face à « fleuve » : les résonances entre ces lexies insiste sur l'idée centrale par résonance lexicale dans Alcools.", keywords: ["champ lexical", "rive", "fleuve", "bateau", "voyage", "métaphor"] }
    ]
  },
  {
    id: "GT-134",
...
Et puis voici mon cœur qui ne bat que pour vous.`,
    ...
    attendus: [
      ...
      { procede: "Champ lexical", citation: "« fruits », « fleurs », « cœur »", interpretation: "Le champ lexical repéré (« fruits », « fleurs ») enveloppe « fruits » face à « fleurs » : les résonances entre ces lexies insiste sur l'idée centrale par résonance lexicale dans Romances sans paroles.", keywords: ["champ lexical", "fruits", "fleurs", "cœur", "nature", "corps"] }
    ]
  },
  {
    id: "GT-135",
...
Je le suis, je veux l'être, je le dis à Rome.`,
    ...
    attendus: [
      ...
      { procede: "Registre épique", citation: "« maître de l'univers »", interpretation: "Registre épique: la scène élève l'action au niveau du grand récit et exalte la scène; « maître de l'univers » concentre cette coloration de la fierté.", keywords: ["épique", "maître", "grandeur", "cornel", "tragique", "héros"] },
...
Oubliant nostre amour de me mesprendre.`,
    ...
    attendus: [
      ...
      { procede: "Registre pathétique", citation: "« je crains… de me mesprendre »", interpretation: "À travers « je crains… de me mesprendre », le registre pathétique domine et suscite la compassion et l'indignation face à la souffrance.", keywords: ["pathétique", "crains", "oubli", "pit", "amante", "peur"] },
      { procede: "Apostrophe", citation: "« Ne te voyant plus »", interpretation: "En s'adressant directement (« Ne te voyant plus »), le locuteur use de l'apostrophe pour implique le lecteur ou un destinataire absent.", keywords: ["apostrophe", "voyant", "aimé", "absent", "invoqu", "intens"] }
    ]
  },
  {
    id: "GT-139",
...
Ne laissez jamais ma vue en repos.`,
  ...
  {
    id: "GT-140",
    titre: "Les Maîtres sonneurs — incipit",
    auteur: "George Sand",
...
if (typeof GRANDS_TEXTES !== 'undefined') {
  GRANDS_TEXTES.push(...GRANDS_TEXTES_EXTRA5);
}
