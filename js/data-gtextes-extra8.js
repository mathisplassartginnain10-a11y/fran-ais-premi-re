/* Grands textes — lot 9 (GT-181 → GT-200) · fusion au chargement */
const GRANDS_TEXTES_EXTRA8 = [
  {
    id: "GT-181",
    titre: "Rolla — la nuit",
    ...
    attendus: [
      ...
      { procede: "Registre lyrique", citation: "« Rolla, les yeux pleins de larmes »", interpretation: "Registre lyrique: « Rolla, les yeux pleins de larmes » exprime une subjectivité intime et des émotions personnelles, au cœur du désespoir amoureux.", keywords: ["lyrique", "larmes", "rolla", "subjectiv", "mal-être", "amour"] },
      { procede: "Champ lexical", citation: "« sombre », « étoiles », « ciel »", interpretation: "Autour de « sombre » face à « étoiles », le vocabulaire (« sombre », « étoiles », « ciel ») forme un réseau sémantique : le lecteur perçoit poème romantique par accumulation lexicale.", keywords: ["champ lexical", "sombre", "étoiles", "ciel", "nocturne", "mélancol"] },
...
Effleurait le tapis du boudoir.`,
    ...
    attendus: [
      ...
      { procede: "Registre poétique", citation: "« boudoir », « tapis »", interpretation: "Registre poétique: par « boudoir », Théophile Gautier privilégie la beauté formelle, la suggestion et la musicalité — tonalité dominante de Émaux et Camées.", keywords: ["poétique", "boudoir", "raffin", "beauté", "pure", "cadre"] },
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Métaphore filée", citation: "corps décomposé / amour mort", interpretation: "En transposant le sens de corps décomposé / amour mort, Charles Baudelaire métaphorise la scène ; le lecteur condense une idée complexe en une image frappante.", keywords: ["métaphore filée", "charogne", "amour", "dégrad", "spleen", "symbole"] }
    ]
  },
  {
    id: "GT-185",
    titre: "Les Travailleurs de la mer — Gilliatt",
    auteur: "Victor Hugo",
    ...
    attendus: [
      ...
      { procede: "Champ lexical", citation: "« vagues », « vent », « rochers »", interpretation: "Autour de « vagues » face à « vent », le vocabulaire (« vagues », « vent », « rochers ») forme un réseau sémantique : le lecteur perçoit roman maritime par accumulation lexicale.", keywords: ["champ lexical", "vagues", "vent", "rochers", "marin", "hostile"] }
    ]
  },
  {
    id: "GT-186",
    titre: "Consuelo — la voix",
    auteur: "George Sand",
    ...
    attendus: [
      ...
      { procede: "Hyperbole", citation: "« les plus durs » pleurent", interpretation: "« les plus durs » relève de l'hyperbole : l'amplification souligne l'intensité du ressenti et fixe l'émotion autour de roman artistique.", keywords: ["hyperbole", "durs", "pleurent", "cœurs", "art", "force"] },
  ...
  {
    id: "GT-187",
    titre: "L'Éducation sentimentale — Frédéric",
  ...
  {
    id: "GT-188",
    titre: "Au bonheur des dames — le magasin",
    auteur: "Émile Zola",
    ...
    attendus: [
      ...
      { procede: "Registre épique", citation: "« resplendissait », « triomphe »", interpretation: "Registre épique: la scène élève l'action au niveau du grand récit et exalte la scène; « resplendissait » concentre cette coloration du monde du commerce.", keywords: ["épique", "temple", "consommat", "grandeur", "zola", "resplend"] },
      { procede: "Accumulation", citation: "« soieries », « clients », « caisses »", interpretation: "Accumulation repérée dans « soieries »: la liste multiplie les occurrences et renforce l'idée centrale de le monde du commerce.", keywords: ["accumulation", "soieries", "clients", "caisses", "profusion", "spectacle"] }
    ]
  },
  {
    id: "GT-189",
  ...
  {
    id: "GT-197",
    titre: "Manon Lescaut — la rencontre",
    auteur: "Abbé Prévost",
  ...
  {
    id: "GT-198",
    titre: "Le Grand Meaulnes — la fête",
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Registre satirique", citation: "« juge, jaloux, condamna malgré tout »", interpretation: "Registre satirique: par « juge, jaloux, condamna malgré tout », Voltaire dénonce les mœurs ou les institutions par l'ironie et la dérision — tonalité dominante de Zadig.", keywords: ["satirique", "juge", "jaloux", "arbitraire", "pouvoir", "voltaire"] },
  ...
  {
    id: "GT-200",
    titre: "La Promesse de l'aube — la mère",
    auteur: "Romain Gary",
...
if (typeof GRANDS_TEXTES !== 'undefined') {
  GRANDS_TEXTES.push(...GRANDS_TEXTES_EXTRA8);
}
