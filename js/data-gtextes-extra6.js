/* Grands textes — lot 7 (GT-141 → GT-160) · fusion au chargement */
const GRANDS_TEXTES_EXTRA6 = [
  {
    id: "GT-141",
    titre: "Carmen — incipit",
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Registre épique", citation: "« temples », « palmiers »", interpretation: "Registre épique: par « temples », Gustave Flaubert élève l'action au niveau du grand récit et exalte la scène — tonalité dominante de Salammbô.", keywords: ["épique", "temples", "carthage", "grandios", "histor", "décor"] },
      { procede: "Champ lexical", citation: "« bleu profond », « flammes », « palmiers »", interpretation: "Gustave Flaubert densifie le passage avec un champ lexical centré sur bleu (« bleu », « profond », « flammes », « palmiers »), ce qui insiste sur l'idée centrale par résonance lexicale et ancre le thème de roman historique.", keywords: ["champ lexical", "bleu", "flamme", "palmiers", "exot", "orient"] },
      { procede: "Focalisation zéro", citation: "description panoramique", interpretation: "Focalisation zéro: « description panoramique » — le narrateur omniscient connaît et relate les faits avec une vision globale de carthage.", keywords: ["focalisation zéro", "panoram", "tableau", "descript", "externe", "ensemble"] },
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Registre didactique", citation: "éducation de Télémaque", interpretation: "Registre didactique: « éducation de Télémaque » vise à instruire le lecteur et à transmettre une leçon morale ou intellectuelle, au cœur de l'éducation du prince.", keywords: ["didact", "éducat", "prince", "moral", "classique", "récit"] },
      { procede: "Champ lexical", citation: "« mers », « dangers », « déceptions »", interpretation: "Autour de « mers » face à « dangers », le vocabulaire (« mers », « dangers », « déceptions ») forme un réseau sémantique : le lecteur perçoit roman moral par accumulation lexicale.", keywords: ["champ lexical", "mers", "dangers", "voyage", "odyssée", "péril"] }
    ]
  },
  {
    id: "GT-144",
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Champ lexical", citation: "« yeux », « azur »", interpretation: "Les mots « yeux », « azur », « champ lexical » appartiennent au même champ sémantique. Leur convergence renforce l'amour et engagement et structure l'unité thématique du passage.", keywords: ["champ lexical", "yeux", "azur", "couleur", "espoir", "symbol"] }
    ]
  },
  {
    id: "GT-149",
...
Et tu entreras dans la ville sans nom.`,
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Registre satirique", citation: "subversion morale", interpretation: "Registre satirique: « subversion morale » dénonce les mœurs ou les institutions par l'ironie et la dérision, au cœur de la perversité.", keywords: ["satirique", "morale", "iron", "bourgeois", "dénonc", "subvers"] },
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Registre didactique", citation: "maxime sur le jeu", interpretation: "Registre didactique: la scène vise à instruire le lecteur et à transmettre une leçon morale ou intellectuelle; « maxime sur le jeu » concentre cette coloration de la passion du jeu.", keywords: ["didact", "maxime", "jeu", "passion", "morale", "comédie"] },
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Registre didactique", citation: "maxime sur la bataille", interpretation: "Registre didactique: la scène vise à instruire le lecteur et à transmettre une leçon morale ou intellectuelle; « maxime sur la bataille » concentre cette coloration de l'amour.", keywords: ["didact", "maxime", "bataille", "amour", "raison", "romant"] },
      { procede: "Registre tragique", citation: "« On ne badine pas avec l'amour » implicite", interpretation: "À travers « On ne badine pas avec l'amour », le registre tragique domine et installe une fatalité qui dépasse les personnages et provoque terreur ou pitié.", keywords: ["tragique", "amour", "fatal", "force", "sérieux", "badine"] }
    ]
  }
];

if (typeof GRANDS_TEXTES !== 'undefined') {
  GRANDS_TEXTES.push(...GRANDS_TEXTES_EXTRA6);
}
