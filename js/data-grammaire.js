...
const GRAM_QCM = [
  ...
  {cat:"Les Modes",q:"'Elle se souvient de tout.' — quel type de pronominale ?",opts:["Réfléchie","Réciproque","Lexicale (se souvenir n'existe qu'en pronominal)","Passive"],ans:2,expl:"Se souvenir, s'évanouir, se repentir = verbes essentiellement pronominaux — pas de forme active."},
