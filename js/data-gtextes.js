...
Feuille morte.`,
    ...
    attendus: [
      {
        procede: "Assonance",
        citation: "« Les sanglots longs / Des violons / De l'automne »",
        interpretation: "L'assonance en [ɔ̃] relie « sanglots », « longs », « violons », « automne ». Cette répétition vocale grave imite la plainte des violons et installe une atmosphère mélancolique.",
        keywords: ["assonance", "ɔ̃", "voyelle", "mélancol", "plainte", "violon", "musical", "automne", "grave"]
      },
      {
        procede: "Enjambement",
        citation: "« Et je m'en vais / Au vent mauvais »",
        interpretation: "La phrase déborde d'un vers sur l'autre : le sujet « je » est emporté par le vent. L'enjambement brise le rythme attendu et traduit l'instabilité du poète, ballotté comme une feuille.",
        keywords: ["enjambement", "vers", "phrase", "déborde", "rythme", "instab", "vent", "emport"]
      },
      {
        procede: "Comparaison",
        citation: "« Pareil à la / Feuille morte »",
        interpretation: "Comparaison explicite avec « pareil à » : le poète se compare à une feuille morte emportée par le vent. Il exprime son impuissance face au temps qui passe.",
        keywords: ["comparaison", "pareil", "feuille", "morte", "vent", "impuiss", "passage", "temps"]
      },
      {
        procede: "Registre lyrique",
        citation: "« Je me souviens / Des autres jours / Et je pleure »",
        interpretation: "Expression directe du « je » poétique et de sentiments intimes (souvenir, larmes, langueur). Le registre lyrique domine : subjectivité et mélancolie personnelle.",
        keywords: ["lyrique", "je", "sentiment", "mélancol", "subjectiv", "pleure", "souvenir", "intime"]
      },
      {
        procede: "Champ lexical",
        citation: "« Feuille morte », « automne », « blême », « pleure »",
        interpretation: "Champ lexical de la mort, de la fin et de la tristesse : « morte », « automne », « blême », « pleure ». Ces mots construisent une atmosphère de déclin et de finitude.",
        keywords: ["champ lexical", "mort", "automne", "trist", "fin", "déclin", "blême", "pleure"]
      },
      {
        procede: "Gradation",
        citation: "« langueur » → « je pleure » → « Feuille morte »",
        interpretation: "Gradation mélancolique : de la langueur au pleur, puis à l'effacement identitaire (feuille morte) — le spleen s'intensifie jusqu'à l'abandon total.",
        keywords: ["gradation", "langueur", "pleure", "feuille", "morte", "mélancol", "intens", "spleen"]
      }
    ]
  },
  {
    ...
    attendus: [
      {
        ...
        interpretation: "La litote dit moins pour faire entendre plus : « ne te hais point » signifie en réalité « je t'aime profondément ». Chimène masque sa passion par pudeur tragique.",
        keywords: ["litote", "moins", "aime", "hais", "pudeur", "passion", "masque", "intens"]
      },
      {
        procede: "Oxymore",
        citation: "« Cette obscure clarté qui tombe des étoiles »",
        interpretation: "L'oxymore unit « obscure » et « clarté » dans un même groupe nominal. Corneille exprime l'ambiguïté d'une nuit étoilée qui éclaire sans suffire — image de la situation tragique de Chimène.",
        keywords: ["oxymore", "obscure", "clarté", "contradict", "ambigu", "étoile", "nuit"]
      },
      {
        procede: "Antithèse",
        citation: "« Je ne te hais point, mais je ne puis te pardonner »",
        interpretation: "Antithèse entre l'amour (« ne te hais point ») et le devoir (« ne puis te pardonner »). Deux sentiments opposés se heurtent et structurent le conflit intérieur du personnage.",
        keywords: ["antithèse", "amour", "devoir", "oppos", "pardonner", "hais", "conflit", "contraste"]
      },
      {
        procede: "Registre tragique",
        citation: "« Mon honneur est en jeu, et mon devoir m'oblige »",
        interpretation: "Registre tragique : Chimène est prise entre passion amoureuse et devoir familial, soumise à une fatalité morale qu'elle ne peut contourner. Terreur et pitié chez le spectateur.",
        keywords: ["tragique", "honneur", "devoir", "fatal", "passion", "pit", "terreur", "conflit"]
      },
      {
        procede: "Métaphore",
        citation: "« Cette obscure clarté qui tombe des étoiles »",
        interpretation: "La lumière des étoiles est présentée comme une clarté obscure — métaphore de la situation : tout est visible et pourtant le chemin reste incertain, comme l'avenir des amants.",
        keywords: ["métaphore", "lumière", "étoile", "clarté", "chemin", "incert", "image"]
      }
    ]
  },
  {
...
Ô dieux ! que n'ai-je au fond des mers une retraite !`,
    ...
    attendus: [
      {
        procede: "Anaphore",
        citation: "« J'ai voulu, j'ai tenté… / J'ai voulu, j'ai tenté… »",
        interpretation: "Anaphore : répétition de « J'ai voulu, j'ai tenté » en début de vers. Martèlement qui insiste sur l'effort vain de Phèdre pour résister à sa passion — effet incantatoire et pathétique.",
        keywords: ["anaphore", "répét", "voulu", "tenté", "martel", "insist", "effort", "vain"]
      },
      {
        procede: "Hyperbole",
        citation: "« Que n'ai-je au fond des mers une retraite ! »",
        interpretation: "Hyperbole : souhait exagéré de se cacher au fond des mers pour échapper à la passion. Phèdre pousse l'expression au-delà du réaliste pour traduire l'intensité de sa souffrance.",
        keywords: ["hyperbole", "exag", "mers", "retraite", "souffr", "intens", "échapp"]
      },
      {
        procede: "Personnification",
        citation: "« Mais le malheur m'attire, et je ne puis le fuir »",
        interpretation: "Personnification : le « malheur » accomplit l'action d'attirer Phèdre comme un être actif. L'abstraction devient une force fatale quasi vivante qui la possède.",
        keywords: ["personnification", "malheur", "attire", "actif", "force", "fatal", "abstrac", "vivant"]
      },
      {
        procede: "Registre tragique",
        citation: "« Mais le malheur m'attire, et je ne puis le fuir »",
        interpretation: "Registre tragique : Phèdre est soumise à une fatalité (Vénus) qui la dépasse. Elle ne peut échapper à sa faute — terreur et pitié, mécanique de la tragédie racinienne.",
        keywords: ["tragique", "fatal", "malheur", "faute", "passion", "pit", "dépasse", "Vénus"]
      },
      {
        procede: "Antithèse",
        citation: "« J'ai voulu… vaincre ma fureur » / « le malheur m'attire »",
        interpretation: "Antithèse entre la volonté de fuir (« vaincre », « fuir ») et l'attraction fatale (« m'attire »). Le personnage est déchiré entre raison et passion.",
        keywords: ["antithèse", "fuir", "attire", "volonté", "passion", "déchir", "oppos"]
      }
    ]
  },
  {
...
Triste, et le jour pour moi sera comme la nuit.`,
    ...
    attendus: [
      {
        procede: "Anaphore",
        citation: "« Je partirai… / J'irai… / J'irai… / Je marcherai… »",
        interpretation: "Anaphore du « je » et des futurs « j'irai », « je marcherai » : insistance sur le projet de départ obstiné. Rythme martelé qui traduit la détermination du deuil.",
        keywords: ["anaphore", "je", "irai", "partir", "répét", "détermin", "deuil", "martel"]
      },
      {
        procede: "Énumération",
        citation: "« Seul, inconnu, le dos courbé, les mains croisées, / Triste »",
        interpretation: "Énumération : liste de traits physiques et moraux du poète en deuil. Chaque terme ajoute une dimension à la solitude — effet de plénitude mélancolique.",
        keywords: ["énumération", "liste", "seul", "inconnu", "triste", "deuil", "plénitude", "solitude"]
      },
      {
        procede: "Comparaison",
        citation: "« le jour pour moi sera comme la nuit »",
        interpretation: "Comparaison avec « comme » : le jour = la nuit pour le poète en deuil. Le temps perd sa clarté — tout est obscurci par la perte de l'être aimé.",
        keywords: ["comparaison", "comme", "jour", "nuit", "deuil", "obscur", "perte"]
      },
      {
        procede: "Registre lyrique",
        citation: "« Triste, et le jour pour moi sera comme la nuit »",
        interpretation: "Registre lyrique (ton élégiaque) : plainte mélancolique, expression de la perte et du deuil. Nostalgie et tristesse dominent — poésie du regret.",
        keywords: ["lyrique", "élégiaque", "deuil", "plainte", "mélancol", "perte", "nostalg", "trist"]
      },
      {
        procede: "Champ lexical",
        citation: "« triste », « seul », « inconnu », « deuil »",
        interpretation: "Champ lexical de la solitude et de la peine : « seul », « inconnu », « triste », « dos courbé ». Cohérence thématique qui installe l'univers du deuil.",
        keywords: ["champ lexical", "solitude", "peine", "seul", "triste", "deuil", "thème"]
      }
    ]
  },
  {
...
On me volait, on me volait, on me volait !`,
    ...
    attendus: [
      {
        procede: "Anaphore",
        citation: "« On me volait, on me volait, on me volait ! »",
        interpretation: "Anaphore de « On me volait » : répétition martelée qui traduit l'obsession d'Harpagon pour son argent. Effet comique par l'excès et la disproportion émotionnelle.",
        keywords: ["anaphore", "volait", "répét", "obsession", "argent", "martel", "excès"]
      },
      {
        procede: "Hyperbole",
        citation: "« c'est une grande trahison que de me voler ainsi »",
        interpretation: "Hyperbole : Harpagon traite le vol d'argent comme une trahison capitale — exagération grotesque qui révèle l'avarice et provoque le rire.",
        keywords: ["hyperbole", "trahison", "exag", "vol", "grotesque", "avarice", "rire"]
      },
      {
        procede: "Registre comique",
        citation: "« On me volait, on me volait, on me volait ! »",
        interpretation: "Registre comique : disproportion entre la perte matérielle et la réaction d'Harpagon (monologue délirant). Comique de caractère — l'avarice poussée à l'absurde.",
...
Les parfums, les couleurs et les sons se répondent.`,
    ...
    attendus: [
      {
        procede: "Métaphore",
        citation: "« La Nature est un temple où de vivants piliers »",
        interpretation: "Métaphore : la Nature est identifiée à un temple sans outil comparatif. Baudelaire sacralise le monde naturel et suggère une présence mystérieuse (piliers « vivants »).",
        keywords: ["métaphore", "nature", "temple", "sacr", "implicite", "piliers", "vivants"]
      },
      {
        procede: "Personnification",
        citation: "« des forêts de symboles / Qui l'observent avec des regards familiers »",
        interpretation: "Personnification : les symboles « observent » l'homme avec des « regards » — traits humains prêtés à des abstractions. Le monde devient actif et inquiétant.",
        keywords: ["personnification", "symbole", "observe", "regard", "humain", "abstrac", "monde"]
      },
      {
        procede: "Comparaison",
        citation: "« Comme de longs échos qui de loin se confondent »",
        interpretation: "Comparaison avec « comme » : les correspondances entre parfums, couleurs et sons sont comparées à des échos qui se confondent — image de l'harmonie universelle.",
        keywords: ["comparaison", "comme", "écho", "confond", "parfum", "couleur", "son"]
      },
      {
        procede: "Antithèse",
        citation: "« Vaste comme la nuit et comme la clarté »",
        interpretation: "Antithèse entre « nuit » et « clarté » : opposés réunis pour dire l'étendue des correspondances — elles englobent toutes les dimensions du sensible.",
        keywords: ["antithèse", "nuit", "clarté", "oppos", "étendue", "sensible", "dimensions"]
      },
      {
        procede: "Registre lyrique",
        citation: "ensemble du poème",
        interpretation: "Registre lyrique et vision poétique subjective : Baudelaire exprime une expérience intime du monde, mélange de mystère, beauté et mélancolie symboliste.",
        keywords: ["lyrique", "subjectiv", "mystère", "symbol", "intime", "expérience", "poète"]
      },
      {
        procede: "Champ lexical",
        citation: "« parfums, couleurs, sons », « symboles », « échos »",
        interpretation: "Champ lexical des sens et du symbolisme : parfums, couleurs, sons, symboles, échos. Cohérence thématique autour de la synesthie et des correspondances.",
        keywords: ["champ lexical", "sens", "parfum", "couleur", "son", "symbole", "synesth"]
      }
    ]
  },

  /* ══ GT-007 à GT-024 — banque étendue ══ */
...
C'est là le sort affreux qui pèse sur les humains.`,
    ...
    attendus: [
      ...
      { procede: "Antithèse", citation: "« Les dieux ont soif, les hommes ont faim »", interpretation: "Antithèse entre « dieux » et « hommes », « soif » et « faim » : opposition symétrique qui universalise la souffrance tragique.", keywords: ["antithèse", "dieux", "hommes", "soif", "faim", "oppos", "symét"] },
      { procede: "Registre tragique", citation: "ensemble du monologue", interpretation: "Registre tragique : Camille est broyée par la fatalité politique et amoureuse. La cité l'emporte sur l'individu — terreur et pitié.", keywords: ["tragique", "fatal", "amour", "politique", "pit", "souffr", "cit"] },
      { procede: "Hyperbole", citation: "« Rome, à qui vient ton bras d'immoler mon amant »", interpretation: "Hyperbole : Rome est personnifiée et accusée d'assassiner l'amant — exagération qui traduit la démesure de la douleur.", keywords: ["hyperbole", "exag", "immoler", "amant", "douleur", "démésure"] },
      { procede: "Personnification", citation: "« Rome… veux que mon cœur adore ta puissance »", interpretation: "Personnification de Rome : la ville agit comme un être tyrannique qui exige l'adoration et broie les passions privées.", keywords: ["personnification", "rome", "puissance", "tyran", "ville", "cœur"] }
    ]
  },
  {
    id: "GT-008",
...
Pour qui sont ces serpents qui sifflent sur vos têtes ?`,
    ...
    attendus: [
      ...
      { procede: "Registre tragique", citation: "ensemble du vers", interpretation: "Registre tragique : l'image obsédante des serpents traduit une menace fatale et une atmosphère d'angoisse.", keywords: ["tragique", "menace", "fatal", "angoiss", "peur"] },
      { procede: "Champ lexical", citation: "« serpents », « sifflent », « têtes »", interpretation: "Champ lexical de la menace et du danger : serpents, sifflement, têtes — vocabulaire qui installe l'inquiétude.", keywords: ["champ lexical", "menace", "danger", "serpent", "peur"] }
    ]
  },
  {
    id: "GT-009",
...
Vous êtes le Phénix des hôtes de ces bois. »`,
    ...
    attendus: [
      ...
      { procede: "Énumération", citation: "« joli », « beau », « ramage », « plumage »", interpretation: "Énumération des compliments du Renard : chaque terme ajoute une louange pour enivrer le Corbeau — insistance de la flatterie.", keywords: ["énumération", "joli", "beau", "plumage", "flatte", "liste", "louange"] },
      ...
      { procede: "Registre comique", citation: "« Hé ! bonjour, Monsieur du Corbeau »", interpretation: "Registre comique : situation burlesque (animal qui parle, flatterie grotesque) — le lecteur anticipe la chute du Corbeau.", keywords: ["comique", "burlesque", "animal", "flatterie", "rire", "situation"] },
      { procede: "Champ lexical", citation: "« joli », « beau », « ramage », « plumage »", interpretation: "Champ lexical de la beauté et de l'apparence : joli, beau, plumage, ramage — insistance sur le leurre de la flatterie.", keywords: ["champ lexical", "beauté", "apparence", "plumage", "flatte"] }
    ]
  },
  {
    id: "GT-010",
...
« Quelle est cette rage de se faire tuer sans profit pour personne ? »`,
    ...
    attendus: [
      ...
      { procede: "Registre pathétique", citation: "« Candide tremblait… ne pouvait s'empêcher de pleurer »", interpretation: "Registre pathétique : la souffrance de Candide suscite la compassion — contraste avec le cynisme de l'officier.", keywords: ["pathétique", "pleure", "trembl", "compassion", "souffr"] },
      { procede: "Hyperbole", citation: "« tremblait de tous ses membres »", interpretation: "Hyperbole : la peur de Candide est exagérée corporellement pour marquer l'horreur ressentie face au massacre.", keywords: ["hyperbole", "trembl", "peur", "membres", "exag", "horreur"] }
    ]
  },
  {
    id: "GT-011",
...
Et son teint au vôtre pareil.`,
    ...
    attendus: [
      ...
      { procede: "Personnification", citation: "« avait déclose / Sa robe de pourpre »", interpretation: "« avait déclose / Sa robe de pourpre » est traité·e comme un agent vivant (personnification) : l'effet est de rend la description plus vivante et d'intensifier carpe diem poétique.", keywords: ["personnification", "rose", "déclose", "robe", "anim", "nature"] },
      { procede: "Champ lexical", citation: "« rose », « pourpre », « teint », « vesprée »", interpretation: "Autour de « rose » face à « pourpre », le vocabulaire (« rose », « pourpre », « teint », « vesprée ») forme un réseau sémantique : le lecteur perçoit carpe diem poétique par accumulation lexicale.", keywords: ["champ lexical", "beauté", "éphém", "rose", "temps", "pourpre"] }
    ]
  },
  {
    id: "GT-012",
...
Et le lac frissonnait sous le vent du soir.`,
    ...
    attendus: [
      ...
      { procede: "Anaphore", citation: "« Le printemps, l'été, l'automne ont passé »", interpretation: "Structure énumérative avec reprise temporelle : les saisons qui passent martèlent l'idée d'un temps irréversible — insistance élégiaque.", keywords: ["anaphore", "saison", "passé", "temps", "répét", "élég"] },
      ...
      { procede: "Registre lyrique", citation: "« emportés sans retour »", interpretation: "Registre lyrique (ton élégiaque) : plainte sur le temps qui fuit et l'amour perdu — mélancolie et nostalgie dominantes.", keywords: ["lyrique", "élégiaque", "mélancol", "perte", "temps", "nostalg", "plainte"] },
      { procede: "Enjambement", citation: "« Ainsi, toujours poussés vers de nouveaux rivages, / Dans la nuit éternelle emportés »", interpretation: "L'enjambement sur « Ainsi, toujours poussés vers de nouveaux rivages, / Dans la nuit éternelle emportés » modifie le rythme du vers : Lamartine retarde ou brise le rythme attendu en lien avec élégie célèbre.", keywords: ["enjambement", "vers", "déborde", "mouvement", "emport", "flux"] },
      { procede: "Contre-rejet", citation: "« …vers de nouveaux rivages, / Dans la nuit éternelle »", interpretation: "Contre-rejet : « rivages » termine le vers alors que le sens continue — suspension avant le débordement, accent sur l'idée de voyage sans fin.", keywords: ["contre-rejet", "rivages", "vers", "suspens", "débord", "fin"] },
...
Et mon Anjou verdoyant, et l'Angevin bocage ?`,
    ...
    attendus: [
      ...
      { procede: "Registre lyrique", citation: "« Quand reverrai-je, hélas, de mon petit village… »", interpretation: "Registre lyrique (ton élégiaque) : « hélas », nostalgie du pays natal, impossibilité du retour — plainte mélancolique.", keywords: ["lyrique", "élégiaque", "hélas", "nostalg", "village", "retour", "plainte"] },
      { procede: "Champ lexical", citation: "« village », « fossés », « cabane », « bocage »", interpretation: "Du Bellay densifie le passage avec un champ lexical centré sur village (« village », « fossés », « cabane », « bocage »), ce qui insiste sur l'idée centrale par résonance lexicale et ancre le thème de du bellay, exilé à rome, regrette son anjou natal.", keywords: ["champ lexical", "campagne", "village", "bocage", "natal", "pays"] },
      { procede: "Anaphore", citation: "« Les fossés… les murs… / Et mon Anjou… et l'Angevin… »", interpretation: "Anaphore des « et » / énumération parallèle : accumulation des lieux regrettés — effet de liste nostalgique.", keywords: ["anaphore", "énumér", "nostalg", "liste", "anjou", "lieux"] },
      { procede: "Sonnet", citation: "structure du poème (2 quatrains + tercets)", interpretation: "Sonnet : forme fixe de 14 vers — Du Bellay éclaire du son élégie en quatrains puis tercets, cadre classique pour la plainte du retour impossible.", keywords: ["sonnet", "14", "quatrains", "tercets", "forme", "fixe", "structure"] },
      { procede: "Registre lyrique", citation: "expression du « je » exilé", interpretation: "Registre lyrique : subjectivité du poète, expression intime du manque et du désir de retrouver les siens.", keywords: ["lyrique", "je", "exil", "subjectiv", "manque", "désir"] }
    ]
  },
  {
    id: "GT-014",
    ...
    attendus: [
      ...
      { procede: "Registre pathétique", citation: "mort de la mère annoncée froidement", interpretation: "Contre-registre : le sujet pathétique (mort de la mère) est traité sans émotion — le pathétique est sous-entendu par l'absence, ce qui choque le lecteur.", keywords: ["pathétique", "mort", "mère", "émotion", "absence", "choc"] }
    ]
  },
  {
    id: "GT-015",
    ...
    attendus: [
      ...
      { procede: "Hyperbole", citation: "« le terrible invisible »", interpretation: "Hyperbole : « terrible » amplifie la menace d'une présence jamais vue — peur exagérée qui installe le malaise.", keywords: ["hyperbole", "terrible", "menace", "peur", "exag", "invisible"] },
      { procede: "Champ lexical", citation: "« hante », « présence », « crains », « invisible »", interpretation: "Champ lexical de la peur et de l'inquiétude : hante, crains, invisible, terrible — atmosphère oppressante.", keywords: ["champ lexical", "peur", "crainte", "invisible", "hante", "inquiét"] }
    ]
  },
  {
    id: "GT-016",
    ...
    attendus: [
      ...
      { procede: "Champ lexical", citation: "« noirs », « charbon », « fosse », « nuit »", interpretation: "Champ lexical de l'enfermement et de la nuit : charbon, fosse, nuit, noirs — univers souterrain oppressant.", keywords: ["champ lexical", "charbon", "fosse", "nuit", "souterrain", "oppress"] }
    ]
  },
  {
    id: "GT-017",
    ...
    attendus: [
      ...
      { procede: "Champ lexical", citation: "« tombé », « balle », « écroulé », « mitraille »", interpretation: "Champ lexical de la violence et de la mort : balle, écroulé, mitraille — vocabulaire de la guerre civile.", keywords: ["champ lexical", "violence", "mort", "balle", "mitraille", "guerre"] }
    ]
  },
...
Quelque grain pour subsister.`,
    ...
    attendus: [
      ...
      { procede: "Antithèse", citation: "« chanté tout l'été » / « crier famine »", interpretation: "Antithèse entre l'insouciance estivale (chanter) et la détresse hivernale (famine) — éclaire du morale de la fable.", keywords: ["antithèse", "été", "hiver", "chanter", "famine", "contraste"] },
      { procede: "Personnification", citation: "La Cigale… La Fourmi sa voisine", interpretation: "Personnification : les insectes parlent, raisonnent et agissent comme des humains — procédé propre à la fable.", keywords: ["personnification", "cigale", "fourmi", "animal", "parle", "fable"] },
      { procede: "Registre comique", citation: "« Pas un seul petit morceau / De mouche ou de vermisseau »", interpretation: "Registre comique léger : détail grotesque de la cigale affamée — ton enjoué qui retient l'attention avant la morale.", keywords: ["comique", "grotesque", "cigale", "famine", "enjoué", "détail"] }
    ]
  },
  {
    id: "GT-020",
...
Que je ne respire et ne vis que pour vous ?`,
    ...
    attendus: [
      ...
      { procede: "Registre pathétique", citation: "amour impossible de Bérénice", interpretation: "Registre pathétique : la souffrance amoureuse de Bérénice suscite la compassion — amour contrarié par le devoir impérial.", keywords: ["pathétique", "amour", "souffr", "bérénice", "compassion", "imposs"] },
      { procede: "Registre lyrique", citation: "« je vous aime… je ne respire et ne vis que pour vous »", interpretation: "Registre lyrique : expression directe des sentiments intimes — « je » amoureux, passion déclarée sans retenue.", keywords: ["lyrique", "aime", "je", "passion", "intime", "sentiment"] },
      ...
      { procede: "Antithèse", citation: "devoir impérial / amour déclaré", interpretation: "Antithèse implicite entre l'amour personnel et le devoir de Titus — tension tragique qui structure la pièce.", keywords: ["antithèse", "devoir", "amour", "titus", "tension", "trag"] }
    ]
  },
  {
    id: "GT-021",
...
Où l'Indécis au Précis se joint.`,
    ...
    attendus: [
      ...
      { procede: "Allitération", citation: "« pèse ou qui pose »", interpretation: "Allitération en [p] : répétition de consonnes qui crée une légèreté sonore — cohérence entre forme et fond.", keywords: ["allitération", "p", "consonne", "pèse", "pose", "sonore"] },
      ...
      { procede: "Enjambement", citation: "vers qui se poursuivent au-delà de la césure", interpretation: "L'enjambement repérée dans le vers qui se poursuivent au-delà de la césure retarde ou brise le rythme attendu; le découpage du vers sert manifeste du symbolisme dans Jadis et naguère.", keywords: ["enjambement", "vers", "déborde", "fluid", "soluble", "air"] }
    ]
  },
  {
    id: "GT-022",
...
Les jours s'en vont je demeure`,
    ...
    attendus: [
      ...
      { procede: "Antithèse", citation: "« La joie venait toujours après la peine »", interpretation: "Antithèse: « La joie venait toujours après la peine » installe une opposition nette qui condense la tension dramatique ou argumentative du passage.", keywords: ["antithèse", "joie", "peine", "oppos", "amour", "cycle"] },
      { procede: "Registre lyrique", citation: "« Faut-il qu'il m'en souvienne »", interpretation: "Registre lyrique (ton élégiaque) : souvenir mélancolique de l'amour perdu — nostalgie du temps qui passe sous le pont.", keywords: ["lyrique", "élégiaque", "souvenir", "mélancol", "amour", "perdu", "temps"] },
      { procede: "Registre lyrique", citation: "« Et nos amours »", interpretation: "Registre lyrique : expression intime de l'amour et de la mémoire affective — « nos amours » personnelles.", keywords: ["lyrique", "amours", "intime", "mémoire", "affectif", "nos"] },
      { procede: "Champ lexical", citation: "« nuit », « heure », « jours », « demeure »", interpretation: "Apollinaire densifie le passage avec un champ lexical centré sur nuit (« nuit », « heure », « jours », « demeure »), ce qui insiste sur l'idée centrale par résonance lexicale et ancre le thème de poème célèbre sur le temps et l'amour passé.", keywords: ["champ lexical", "temps", "nuit", "heure", "jours", "demeure"] }
    ]
  },
  {
    id: "GT-023",
...
Ah ! coquin, coquin, coquin, coquin !`,
    ...
    attendus: [
      ...
      { procede: "Hyperbole", citation: "« Ah ! le coquin ! »", interpretation: "En exagérant « Ah ! le coquin ! », le texte use de l'hyperbole afin de souligne l'intensité du ressenti — procédé fréquent chez Molière.", keywords: ["hyperbole", "coquin", "exag", "théâtr", "indign", "surjou"] },
      { procede: "Litote", citation: "« Non, tu ne le serais pas… Si fait, tu le serais »", interpretation: "Litote et feinte retenue : Scapin dit moins (« je ne crois pas ») pour faire entendre plus (suspicion certaine) — comique de l'hésitation simulée.", keywords: ["litote", "feinte", "hésit", "comique", "simul", "retenue"] }
    ]
  },
  {
    id: "GT-024",
...
Dans un pleur qui ne pleure pas.`,
    ...
    attendus: [
      ...
      { procede: "Comparaison", citation: "« Les soleils mouillés… / Pour mon esprit ont les charmes / Si mystérieux / De tes yeux »", interpretation: "Comparaison implicite entre ciels brouillés et yeux de la bien-aimée — rapprochement sensoriel et mystérieux.", keywords: ["comparaison", "yeux", "ciel", "charme", "mystér", "soleil"] },
...
Et vous ne m'attirerez plus par vos manèges.`,
    ...
    attendus: [
      ...
      { procede: "Anaphore", citation: "« Non, non » / « Le Ciel… l'ordre du Ciel »", interpretation: "Anaphore de « non » et reprise de « Ciel / ordre du Ciel » : insistance théâtrale qui masque la manipulation.", keywords: ["anaphore", "non", "ciel", "répét", "insist", "théâtr"] },
      { procede: "Antithèse", citation: "« quitter » / « vous m'attirerez »", interpretation: "Antithèse entre le prétendu départ vertueux et la volonté de séduire encore — contradiction qui révèle le faux-semblant.", keywords: ["antithèse", "quitter", "attir", "contradict", "vertu", "séduire"] },
      { procede: "Hyperbole", citation: "« tout ici est souillé »", interpretation: "« tout ici est souillé » relève de l'hyperbole : l'amplification souligne l'intensité du ressenti et fixe l'émotion autour de tartuffe simule la dévotion pour tromper orgon.", keywords: ["hyperbole", "souill", "exag", "monde", "rigueur", "caricature"] },
      { procede: "Champ lexical", citation: "« Ciel », « ordre », « pièges », « manèges »", interpretation: "Champ lexical de la fausse morale et du stratagème : ciel, ordre, pièges, manèges — vocabulaire de la tromperie déguisée en vertu.", keywords: ["champ lexical", "moral", "piège", "manège", "tromper", "vertu"] }
    ]
  },
  {
    id: "GT-026",
    ...
    attendus: [
      ...
      { procede: "Registre pathétique", citation: "désir d'ailleurs d'Emma", interpretation: "Registre pathétique : la beauté du bal révèle la misère du quotidien d'Emma — compassion pour une femme en quête d'idéal.", keywords: ["pathétique", "misère", "idéal", "emma", "compassion", "quotidien"] },
      { procede: "Champ lexical", citation: "« cristal », « argent », « girandoles », « fauteuils »", interpretation: "Champ lexical du luxe et de l'apparat : cristal, argent, girandoles — contraste avec la vie provinciale d'Emma.", keywords: ["champ lexical", "luxe", "cristal", "argent", "apparat", "contraste"] }
    ]
  },
  {
    id: "GT-027",
...
Ah ! pour être honnête homme, je donnerais tous les honnêtes gens du monde ; et je ne crois pas qu'on puisse faire une plaisanterie plus plaisante que de se moquer d'eux.`,
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Antithèse", citation: "« difforme… informe »", interpretation: "Antithèse repérée dans « difforme… informe »: deux termes ou idées s'opposent pour souligner pathétique et grotesque.", keywords: ["antithèse", "difforme", "informe", "intens", "monstru", "contraste"] },
      { procede: "Hyperbole", citation: "« à peu près difforme… informe »", interpretation: "En exagérant « à peu près difforme… informe », le texte use de l'hyperbole afin de souligne l'intensité du ressenti — procédé fréquent chez Hugo.", keywords: ["hyperbole", "informe", "exag", "grotesque", "difform", "corps"] },
      { procede: "Champ lexical", citation: "« voûté », « osseuse », « bosse », « estropiée »", interpretation: "Le champ lexical repéré (« voûté », « osseuse », « bosse », « estropiée ») enveloppe « voûté » face à « osseuse » : les résonances entre ces lexies insiste sur l'idée centrale par résonance lexicale dans Notre-Dame de Paris.", keywords: ["champ lexical", "corps", "mutil", "bosse", "estropi", "osseux"] }
    ]
  },
  {
    id: "GT-029",
...
Pour me punir, que de choisir un si faible instrument ?`,
    ...
    attendus: [
      ...
      { procede: "Anaphore", citation: "« Un enfant, un enfant roi ! »", interpretation: "L'anaphore (« Un enfant, un enfant roi ! ») fonctionne comme un leitmotiv : elle martèle l'idée directrice et renforce la cohésion du passage.", keywords: ["anaphore", "enfant", "roi", "répét", "angoiss", "reine"] },
      ...
      { procede: "Antithèse", citation: "« si faible instrument » / punition divine", interpretation: "Antithèse entre la faiblesse de l'enfant et la puissance de la punition — Dieu humilie la reine par le dérisoire.", keywords: ["antithèse", "faible", "enfant", "punir", "dérisoire", "dieu"] },
      { procede: "Registre pathétique", citation: "tremblement d'Athalie", interpretation: "Registre pathétique : la souffrance et la peur d'Athalie suscitent une pité troublée — même la tyranne devient une proie.", keywords: ["pathétique", "souffr", "pit", "peur", "athalie", "tyranne"] }
    ]
  }
];
