/* Grands textes — lot 12 (GT-241 → GT-260) · fusion au chargement */
const GRANDS_TEXTES_EXTRA11 = [
  {
    id: "GT-241",
    titre: "Delphine — la passion",
  ...
  {
    id: "GT-245",
    titre: "La Cousine Bette — la jalousie",
  ...
  {
    id: "GT-251",
    titre: "Les Garçons — l'adolescence",
    ...
    attendus: [
      ...
      { procede: "Énumération", citation: "« riaient, combattaient, s'aimaient »", interpretation: "Énumération repérée dans « riaient, combattaient, s'aimaient »: la liste multiplie les occurrences et renforce l'idée centrale de le pension.", keywords: ["énumération", "riaient", "combatt", "aimaient", "vitalité", "présent"] }
    ]
  },
  {
    id: "GT-252",
    titre: "La Jeune Parque — la nuit",
    auteur: "Paul Valéry",
  ...
  {
    id: "GT-259",
    titre: "La Mare au diable — le soir",
    auteur: "George Sand",
  ...
  {
    id: "GT-260",
    titre: "Les Médailles d'argent — le temps",
...
if (typeof GRANDS_TEXTES !== 'undefined') {
  GRANDS_TEXTES.push(...GRANDS_TEXTES_EXTRA11);
}
