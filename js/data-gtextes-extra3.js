...
const GRANDS_TEXTES_EXTRA3 = [
  {
    ...
    attendus: [
      { procede: "Antithèse", citation: "« ne devais pas vous aimer »", interpretation: "Antithèse: « ne devais pas vous aimer » s'oppose à « estime et tendresse ». Cette tension structure le sens et oblige le lecteur à mesurer l'écart entre les deux idées.", keywords: ["antithèse","devoir","tendresse","passion","contraste","moral"] },
      ...
      { procede: "Champ lexical", citation: "« donner des marques de mon estime et de ma tendresse. »", interpretation: "Champ lexical de l'affect : vocabulaire nuancé qui distingue estime, tendresse et amour — psychologie fine.", keywords: ["champ lexical","estime","tendresse","aimer","affect","psycholog"] },
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Registre lyrique", citation: "« ne soit plus heureux que moi dans le monde entier. »", interpretation: "À travers « mal du siècle », le registre lyrique domine et exprime une subjectivité intime et des émotions personnelles.", keywords: ["lyrique","je","romant","mélancol","subjectiv","spleen"] },
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Sonnet", citation: "« Ténébreux, — le Veuf, — l'Inconsolé, … Porte le Soleil noir de la Mélancolie. »", interpretation: "Sonnet: forme fixe de quatorze vers (2 quatrains + 2 tercets). La contrainte concentre identité multiple du poète et prépare souvent une chute au tercet.", keywords: ["sonnet","forme","contrainte","symbol","dense","fixe"] }
    ]
  },
  {
    id: "GT-084",
    ...
    attendus: [
      { procede: "Comparaison", citation: "« moi hurlait. »", interpretation: "Le parallèle introduit par « comme une reine » (comparaison) facilite la visualisation de la scène et précise la dimension poème en prose lyrique du passage.", keywords: ["comparaison","comme","reine","passante","idéal","transfig"] },
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Champ lexical", citation: "« avait, dans l'île Bourbon, une maison bien connue, qu'on appelait le manoir de B… … Elle était situé »", interpretation: "Champ lexical centré sur cadre exotique: « île », « Bourbon », « caféiers ». Ces résonances lexicales créent une atmosphère cohérente et insistent sur l'idée directrice.", keywords: ["champ lexical","île","café","exot","colonial","vallon"] },
  ...
  },
  {
    ...
    attendus: [
      { procede: "Métaphore", citation: "« pierre, un désert de maisons, un abîme où l'on ne pouvait rien distinguer. »", interpretation: "Par la métaphore (« océan », « pierre », « désert », « maisons »), le réel est détourné : Balzac condense une idée complexe en une image frappante tout en ancrant lucien chardon découvre paris.", keywords: ["métaphore","océan","pierre","désert","paris","écrase"] },
      ...
      { procede: "Antithèse", citation: "« de Saint-Sulpice ; »", interpretation: "Antithèse repérée dans « océan de pierre »: deux termes ou idées s'opposent pour souligner roman de l'ascension sociale et de la désillusion.", keywords: ["antithèse","provinc","métropole","choc","contraste","monde"] }
    ]
  },
  {
    id: "GT-087",
    ...
    attendus: [
      { procede: "Registre satirique", citation: "« commencèrent à s'ennuyer à mourir, et, faute de mieux, on parla de cette fille, bien entendu avec de »", interpretation: "À travers « plaisanteries et grossièretés », le registre satirique domine et dénonce les mœurs ou les institutions par l'ironie et la dérision.", keywords: ["satirique","hypocris","bourgeois","mépris","grossi","dénonc"] },
      ...
      { procede: "Antithèse", citation: "« commencèrent à s'ennuyer à mourir, et, faute de mieux, on parla de cette fille, bien entendu avec de »", interpretation: "Antithèse entre « occupants » et « cette fille »: le contraste met en relief deux pôles opposés et accentue hypocrisie bourgeoise pendant la guerre de 1870.", keywords: ["antithèse","respect","vulgar","contraste","moral","fille"] },
      { procede: "Champ lexical", citation: "« commencèrent à s'ennuyer à mourir, et, faute de mieux, on parla de cette fille, bien entendu avec de »", interpretation: "Les mots « plaisanteries », « grossièretés », « s'ennuyer » appartiennent au même champ sémantique. Leur convergence renforce hypocrisie bourgeoise pendant la guerre de 1870 et structure l'unité thématique du passage.", keywords: ["champ lexical","grossi","mépris","trivial","bassesse","voyageur"] },
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Anaphore", citation: "« seigneur, vous vous croyez un grand génie !… … Qu'avez-vous fait pour tant de biens ? »", interpretation: "L'anaphore (« Noblesse, fortune, un rang, des places ») fonctionne comme un leitmotiv : elle martèle l'idée directrice et renforce la cohésion du passage.", keywords: ["anaphore","noblesse","fortune","rang","énumér","liste"] },
  ...
  },
  {
    ...
    attendus: [
      { procede: "Antithèse", citation: "« quitter la vie »", interpretation: "Antithèse: « quitter la vie » s'oppose à « veut que je vive ». Cette tension structure le sens et oblige le lecteur à mesurer l'écart entre les deux idées.", keywords: ["antithèse","mort","vivre","clémence","contraste","auguste"] },
      ...
      { procede: "Alexandrin", citation: "« suivre, il faut quitter la vie, … Il m'ôte le moyen de mourir à sa pitié. »", interpretation: "L'alexandrin repérée dans le vers en douze syllabes retarde ou brise le rythme attendu; le découpage du vers sert auguste face à cinna dans Cinna.", keywords: ["alexandrin","douze","syllabe","classique","cornel","dignité"] },
      { procede: "Champ lexical", citation: "« suivre, il faut quitter la vie, … Il m'ôte le moyen de mourir à sa pitié. »", interpretation: "Le champ lexical repéré (« mourir », « bonté », « pitié ») enveloppe « vie » face à « mourir » : les résonances entre ces lexies insiste sur l'idée centrale par résonance lexicale dans Cinna.", keywords: ["champ lexical","vie","mourir","bonté","pit","moral"] }
    ]
  },
  {
    id: "GT-091",
    ...
    attendus: [
      ...
      { procede: "Registre pathétique", citation: "« en tremblant »", interpretation: "Registre pathétique: la scène suscite la compassion et l'indignation face à la souffrance; « en tremblant… en vain » concentre cette coloration du tragédie biblique.", keywords: ["pathétique","trembl","proie","pit","innoc","persécut"] },
      ...
      { procede: "Apostrophe", citation: "« Seigneur »", interpretation: "En s'adressant directement (« Seigneur… votre autel »), le locuteur use de l'apostrophe pour implique le lecteur ou un destinataire absent.", keywords: ["apostrophe","seigneur","dieu","relig","lyrique","autel"] },
      { procede: "Alexandrin", citation: "« viens, Seigneur, je viens, je viens en tremblant … Vous seul connaissez mon innocence et mon crime. »", interpretation: "L'alexandrin repérée dans le vers en douze syllabes retarde ou brise le rythme attendu; le découpage du vers sert esther implore dieu dans Esther.", keywords: ["alexandrin","solenn","tragique","racine","vers","cadence"] }
    ]
  },
  {
    id: "GT-092",
    ...
    attendus: [
      { procede: "Registre satirique", citation: "« souffrir, et j'enrage en mon âme, … Se laissent conduire au gré de leurs appétits. »", interpretation: "À travers « lâche bassesse… lâches mortels », le texte bascule dans un registre satirique ; le lecteur est invité à critiquer les mœurs et les institutions par le rire, ce qui s'inscrit dans Le Misanthrope.", keywords: ["satirique","lâche","hypocris","monde","critique","moral"] },
      { procede: "Anaphore", citation: "« souffrir, et j'enrage en mon âme, … Se laissent conduire au gré de leurs appétits. »", interpretation: "En reprenant « lâche… lâches », Molière use de l'anaphore pour martèle l'idée directrice ; la répétition éclaire de l'alceste dénonce l'hypocrisie mondaine dans Le Misanthrope.", keywords: ["anaphore","lâche","répét","mépris","alceste","insiste"] },
      ...
      { procede: "Champ lexical", citation: "« souffrir, et j'enrage en mon âme, … Se laissent conduire au gré de leurs appétits. »", interpretation: "Champ lexical: « lâche », « bassesse », « faiblesse ». L'accumulation de ces lexies enveloppe le lecteur dans l'univers de comédie de caractère.", keywords: ["champ lexical","lâche","bassesse","faiblesse","corrupt","moral"] },
      { procede: "Antithèse", citation: "« souffrir, et j'enrage en mon âme, … Se laissent conduire au gré de leurs appétits. »", interpretation: "Antithèse: « mœurs du temps » installe une opposition nette qui condense la tension dramatique ou argumentative du passage.", keywords: ["antithèse","vérité","hypocris","idéal","contraste","monde"] }
    ]
  },
  {
    id: "GT-093",
    ...
    attendus: [
      ...
      { procede: "Registre comique", citation: "« que pour souffrir et pour me faire soig »", interpretation: "Registre comique: « né que pour souffrir et me faire soigner » provoque le rire par la situation, les mots ou les personnages, au cœur du satire de la médecine et du caractère comique.", keywords: ["comique","souffrir","soigner","ridicule","obsession","argan"] },
      { procede: "Antithèse", citation: "« santé, et je suis malade. »", interpretation: "Antithèse repérée dans « né pour souffrir »: deux termes ou idées s'opposent pour souligner satire de la médecine et du caractère comique.", keywords: ["antithèse","souffrir","bon sens","contraste","rire","destin"] },
      { procede: "Champ lexical", citation: "« santé, et je suis malade. »", interpretation: "Molière densifie le passage avec un champ lexical centré sur médecine (« médecine », « souffrir », « soigner », « malade »), ce qui insiste sur l'idée centrale par résonance lexicale et ancre le thème de argan, hypocondriaque.", keywords: ["champ lexical","médecine","malade","soigner","imagin","médical"] },
      { procede: "Gradation", citation: "« Tout ce qui est de moi est à la médecine. »", interpretation: "Gradation: « souffrir… soigner… pas de santé… malade » organise les éléments en intensité croissante ou décroissante. La progression dramatique éclaire du satire de la médecine et du caractère comique.", keywords: ["gradation","souffrir","malade","obsession","intens","comique"] }
    ]
  },
  {
    id: "GT-094",
    ...
    attendus: [
      { procede: "Énumération", citation: "« Murs, ville »", interpretation: "Énumération: les termes « Murs », « ville », « port » juxtaposent plusieurs éléments pour insister sur la peur surnaturelle et produire un effet de plénitude ou d'oppression.", keywords: ["énumération","murs","ville","port","liste","décor"] },
      { procede: "Gradation", citation: "« Murs, ville, … Montent, retombent, ou passent en hurlant. »", interpretation: "Hugo recourt à le gradation (« strophes », « s'allongent ») pour épuise ou exalte selon la visée de l'auteur ; la liste éclaire du poème en strophes de longueur variable dans Les Contemplations.", keywords: ["gradation","strophe","crescendo","rythme","djinns","forme"] },
      { procede: "Personnification", citation: "« Murs, ville, … Montent, retombent, ou passent en hurlant. »", interpretation: "En personnifiant « djinns… en hurlant », le texte rend la description plus vivante ; l'animation du non-humain sert poème en strophes de longueur variable dans Les Contemplations.", keywords: ["personnification","djinns","hurler","surnaturel","peur","vivant"] },
      { procede: "Registre fantastique", citation: "« Murs, ville, … Montent, retombent, ou passent en hurlant. »", interpretation: "Registre fantastique: « fils du feu… en hurlant » trouble la frontière entre réel et surnaturel, au cœur de la peur surnaturelle.", keywords: ["fantastique","feu","surnaturel","terreur","merveill","djinns"] },
      { procede: "Champ lexical", citation: "« Murs, ville, … Montent, retombent, ou passent en hurlant. »", interpretation: "Hugo densifie le passage avec un champ lexical centré sur airs (« airs », « rapides », « hurlant »), ce qui insiste sur l'idée centrale par résonance lexicale et ancre le thème de poème en strophes de longueur variable.", keywords: ["champ lexical","feu","hurler","violence","infern","air"] }
    ]
  },
  {
    id: "GT-095",
    ...
    attendus: [
      ...
      { procede: "Antithèse", citation: "« saisons, ô châtiments … Plus doucement on y serait pris »", interpretation: "Antithèse entre « de son temps malgré tout » et « on ne s'y habitue pas »: le contraste met en relief deux pôles opposés et accentue révolte existentielle.", keywords: ["antithèse","temps","habitue","refus","exist","malaise"] },
      { procede: "Registre lyrique", citation: "« saisons, ô châtiments … Plus doucement on y serait pris »", interpretation: "Registre lyrique: « On est de son temps » exprime une subjectivité intime et des émotions personnelles, au cœur du révolte existentielle.", keywords: ["lyrique","temps","destin","subjectiv","maudit","méditat"] },
      { procede: "Vers libre", citation: "« saisons, ô châtiments … Plus doucement on y serait pris »", interpretation: "Vers libre: « vers sans rime fixe » échappe à la métrique régulière. Arthur Rimbaud privilégie la liberté rythmique et la modernité de révolte existentielle.", keywords: ["vers libre","rupture","moderne","rimbaud","forme","classique"] }
    ]
  },
  {
    id: "GT-096",
    ...
    attendus: [
      { procede: "Antithèse", citation: "« Nous ne lui répondions pas. »", interpretation: "Antithèse repérée dans « visite de l'officier / silence total »: deux termes ou idées s'opposent pour souligner occupant allemand et famille française.", keywords: ["antithèse","silence","ennemi","résist","mutisme","contraste"] },
      ...
      { procede: "Champ lexical", citation: "« là, debout, un instant, puis il s'inclinait légèrement et repartait sans avoir prononcé une parole. »", interpretation: "Champ lexical du silence : répétition du mutisme — refus symbolique de collaborer.", keywords: ["champ lexical","silence","parole","mutisme","refus","symbol"] },
  ...
  },
  {
    ...
    attendus: [
      ...
      { procede: "Champ lexical", citation: "« toujours qu'on va faire quelque chose de bien. »", interpretation: "Autour de « bien » face à « pensent », le vocabulaire (« bien », « pensent », « font ») forme un réseau sémantique : le lecteur perçoit antigone moderne face à créon par accumulation lexicale.", keywords: ["champ lexical","bien","moral","éthique","action","pensent"] }
    ]
  },
  {
    id: "GT-099",
