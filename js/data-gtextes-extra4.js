...
La fleur des fleurs, la fleur à laquelle ne manque
Deux rosisons pareils, que le ciel lui a peints ;`,
    contexte: "Sonnet de la Pléiade — métaphore de la jeunesse et du temps qui passe.",
    attendus: [
      { procede: "Comparaison", citation: "« Comme on voit sur la branche… La rose »", interpretation: "La comparaison « Comme on voit sur la branche… La rose » établit un rapprochement explicite : Ronsard facilite la visualisation de la scène et rend sonnet de la pléiade plus perceptible.", keywords: ["comparaison", "comme", "rose", "branche", "beauté", "temps"] },
      { procede: "Métaphore", citation: "« La rose en sa beauté, tenant lieu de son teint »", interpretation: "En transposant le sens de « La rose en sa beauté, tenant lieu de son teint », Ronsard métaphorise la scène ; le lecteur condense une idée complexe en une image frappante.", keywords: ["métaphore", "rose", "teint", "beauté", "nature", "corps"] },
      { procede: "Hyperbole", citation: "« la fleur des fleurs »", interpretation: "En exagérant « la fleur des fleurs », Ronsard use de l'hyperbole pour souligner la métaphore de la jeunesse et du temps qui passe.", keywords: ["hyperbole", "fleur", "belle", "exag", "éloge", "superlat"] },
      ...
      { procede: "Sonnet", citation: "forme 14 vers", interpretation: "Sonnet: la structure en quatrains et tercets organise de la métaphore de la jeunesse et du temps qui passe et permet un retournement au dernier tercet.", keywords: ["sonnet", "forme", "fixe", "classique", "contrainte", "éloge"] }
    ]
  },
  {
    id: "GT-102",
...
Tu me has nourri du lait de ta mamelle :
Bénis tes fils, bénis tes filles chéries,
Qui parlent hautement en langue francoise.`,
    ...
    attendus: [
      ...
      { procede: "Anaphore", citation: "« Bénis tes fils, bénis tes filles »", interpretation: "L'anaphore sur « Bénis tes fils, bénis tes filles » martèle une forme répétée : l'insistance martèle l'idée directrice et imprime un rythme obsédant propre à Joachim du Bellay.", keywords: ["anaphore", "bénis", "répét", "patrie", "fils", "filles"] },
  ...
  },
  {
    ...
    genre: "Tragédie",
    diff: 2,
    texte: `C'est bien fait ! je suis lâche, et je n'ai plus de cœur.
Puisque j'ai pris les armes pour ma querelle,
Je devrais les remettre pour ma querelle.`,
    ...
    attendus: [
      ...
      { procede: "Champ lexical", citation: "« lâche », « cœur », « armes », « querelle »", interpretation: "Les mots « lâche », « armes », « querelle » appartiennent au même champ sémantique. Leur convergence renforce conflit tragique et structure l'unité thématique du passage.", keywords: ["champ lexical", "lâche", "armes", "honneur", "combat", "héroïq"] },
      { procede: "Alexandrin", citation: "vers en douze syllabes", interpretation: "L'alexandrin repérée dans le vers en douze syllabes retarde ou brise le rythme attendu; le découpage du vers sert rodrigue déchiré entre vengeance et amour dans Le Cid.", keywords: ["alexandrin", "vers", "tragique", "classique", "dignité", "douze"] }
    ]
  },
  {
    id: "GT-104",
    ...
    genre: "Tragédie",
    diff: 3,
    texte: `Quoi ! je ne saurais voir Agamemnon en père,
Et je n'ai plus qu'un cœur pour toute ma famille !
Qu'ai-je donc fait aux dieux, qu'ai-je fait à la Grèce ?`,
    ...
    attendus: [
      ...
      { procede: "Antithèse", citation: "« en père » / « pour toute ma famille »", interpretation: "Antithèse entre « en père » et « pour toute ma famille »: le contraste met en relief deux pôles opposés et accentue tragédie mythologique.", keywords: ["antithèse", "père", "famille", "devoir", "chef", "conflit"] },
      ...
      { procede: "Registre tragique", citation: "« sacrifice » implicite", interpretation: "À travers « sacrifice », le registre tragique domine et installe une fatalité qui dépasse les personnages et provoque terreur ou pitié.", keywords: ["tragique", "fatal", "dieu", "impuiss", "sacrifice", "héros"] },
...
Revenez sur mon âme, retentissez dans mon cœur !
...
Comme un souffle d'été qui passe dans les fleurs.`,
    ...
    attendus: [
      ...
      { procede: "Comparaison", citation: "« Comme un chant de matin… Comme un souffle d'été »", interpretation: "Comparaison repérée dans « Comme un chant de matin… Comme un souffle d'été »: le parallèle rend lyrisme romantique plus concret et guide l'imaginaire du lecteur.", keywords: ["comparaison", "comme", "matin", "été", "nature", "mélancol"] },
      { procede: "Registre lyrique", citation: "« Revenez sur mon âme »", interpretation: "Registre lyrique: par « Revenez sur mon âme », Victor Hugo exprime une subjectivité intime et des émotions personnelles — tonalité dominante de Les Feuilles d'automne.", keywords: ["lyrique", "je", "âme", "passé", "subjectiv", "romant"] },
      { procede: "Champ lexical", citation: "« chants », « voix », « cœur », « souffle »", interpretation: "Victor Hugo densifie le passage avec un champ lexical centré sur chants (« chants », « voix », « souffle »), ce qui insiste sur l'idée centrale par résonance lexicale et ancre le thème de nostalgie du passé.", keywords: ["champ lexical", "chants", "voix", "cœur", "souffle", "musical"] },
...
Et le repos sans fin
De la route sans bruit
Où la destinée est morte.`,
    contexte: "Poème musical — rêve amoureux, vers courts et assonances.",
    attendus: [
      { procede: "Assonance", citation: "vers courts en [u] et [i]", interpretation: "L'assonance autour de « courts » crée une musicalité du vers ou de la phrase : le son renforce l'atmosphère du poème et soutient poème musical.", keywords: ["assonance", "musical", "verlaine", "suggest", "vers", "court"] },
      ...
      { procede: "Champ lexical", citation: "« fuite », « repos », « route sans bruit »", interpretation: "Les occurrences « fuite », « repos », « route », « sans » composent un champ lexical cohérent autour de poème musical ; cette convergence insiste sur l'idée centrale par résonance lexicale et guide la lecture de Paul Verlaine.", keywords: ["champ lexical", "fuite", "repos", "route", "oniriq", "calme"] },
      { procede: "Registre lyrique", citation: "« Mon rêve familier »", interpretation: "À travers « Mon rêve familier », le registre lyrique domine et exprime une subjectivité intime et des émotions personnelles.", keywords: ["lyrique", "rêve", "intime", "amour", "subjectiv", "familier"] },
      { procede: "Vers libre", citation: "vers très courts", interpretation: "Vers libre: « vers très courts » échappe à la métrique régulière. Paul Verlaine privilégie la liberté rythmique et la modernité de rêve amoureux.", keywords: ["vers libre", "court", "musical", "verlaine", "moderne", "rythme"] }
    ]
  },
  {
    id: "GT-107",
    ...
    genre: "Poésie",
    diff: 3,
    texte: `Au bout du petit matin, bourreau des cœurs et des chairs,
Sur le morne plaine mes désespoirs s'ancrent.`,
    ...
    attendus: [
      ...
      { procede: "Champ lexical", citation: "« bourreau », « désespoirs », « morne plaine »", interpretation: "Autour de « bourreau » face à « désespoirs », le vocabulaire (« bourreau », « désespoirs », « morne », « plaine ») forme un réseau sémantique : le lecteur perçoit poésie anticoloniale par accumulation lexicale.", keywords: ["champ lexical", "bourreau", "désesp", "morne", "violence", "révolte"] },
      { procede: "Registre épique", citation: "« retour au pays natal »", interpretation: "Registre épique: « retour au pays natal » élève l'action au niveau du grand récit et exalte la scène, au cœur du révolte.", keywords: ["épique", "retour", "pays", "identité", "grandeur", "quête"] }
    ]
  },
  {
    id: "GT-108",
...
J'ai grandi à ton ombre ; la douceur de tes mains bandait mes yeux.`,
    ...
    attendus: [
      ...
      { procede: "Métaphore", citation: "« couleur qui est vie… forme qui est beauté »", interpretation: "Par la métaphore (« couleur », « forme », « beauté »), le réel est détourné : Léopold Sédar Senghor condense une idée complexe en une image frappante tout en ancrant négritude.", keywords: ["métaphore", "couleur", "vie", "beauté", "identité", "réhabil"] },
  ...
  },
  {
    ...
    genre: "Nouvelle",
    diff: 2,
    texte: `Daru regardait les deux hommes monter vers lui. L'un d'eux, le gendarme, connaissait le chemin. Il avançait devant, le fusil sur l'épaule, l'autre, les mains liées derrière le dos, marchait la tête haute.`,
